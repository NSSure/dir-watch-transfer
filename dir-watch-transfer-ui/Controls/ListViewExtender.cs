...
namespace dir_watch_transfer_ui
{
    ...
    public class ListViewButtonColumn : ListViewColumn
    {
        ...
        public override void Draw(DrawListViewSubItemEventArgs e)
        {
            ...
            {
                ButtonRenderer.DrawButton(e.Graphics, rect, e.SubItem.Text, Font, true, PushButtonState.Hot);
                _hot = e.Bounds;
            }
            else
            {
                ButtonRenderer.DrawButton(e.Graphics, rect, e.SubItem.Text, Font, false, PushButtonState.Default);
            }
        }
    }

    public class ProgressBarColumn : ListViewColumn
    {
        private Rectangle _hot = Rectangle.Empty;

        public ProgressBarColumn(int columnIndex) : base(columnIndex)
        {
        }
